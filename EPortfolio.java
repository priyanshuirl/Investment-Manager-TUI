        ...
        while (iteration == 1) {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    System.out.println("\nChoose the Type of Investment You wanna see the gain for");
                    System.out.println("(1)Stocks");
                    System.out.println("(2)Mutual Funds");
                    System.out.println("\nEnter Your Choice : ");
                    int invtype2 = scan.nextInt();
                    double gainValue;
                    if (invtype2 == 1) {
                        for (Stock sttt : portfolio.getStocks()) {
                            gainValue = ((sttt.getQuantity() * sttt.getPrice()) - 9.99) - sttt.getBookValue();
                            System.out.print("Gain for the stock : " + gainValue);
                        }
                    } else if (invtype2 == 2) {
                        for (MutualFund mutualFund : portfolio.getMutualFunds()) {
                            gainValue = ((mutualFund.getQuantity() * mutualFund.getPrice()) - 9.99)
                                    - mutualFund.getBookValue();
                            System.out.print("Gain for the Mutual Fund : " + gainValue);
                        }
                    } else {
                        System.out.println("Please enter 1 or 2");
                    }
